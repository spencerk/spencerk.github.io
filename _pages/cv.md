...
* **"[Article Title](URL)"**  
  ...
  Brief description or quote if desired

Example:
* **"[How The Met's API is Transforming Museum Access](https://example.com/article)"**  
  _TechCrunch_, March 2023  
  Feature on open access initiatives and developer adoption
